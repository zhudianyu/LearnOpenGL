...
// Light attributes
glm::vec3 lightPos(-1.f, 2.0f, -10.0f);
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "011_LightCaster", nullptr, nullptr);
	...
	Shader lightingShader("../011_LightCaster/lighting.vs", "../011_LightCaster/lighting.frag");
	Shader lampShader("../011_LightCaster/lamp.vs", "../011_LightCaster/lamp.frag");
...
glm::vec3(-1.3f,  1.0f, -1.5f)
	...
	GLint diffuseMap = GenTexture("../Resources/img/container2.png");
	GLint specularMap = GenTexture("../Resources/img/container2_specular.png");
	// Game loop
	while (!glfwWindowShouldClose(window))
	{
		...
		// Draw the container (using container's vertex attributes)w
		glBindVertexArray(containerVAO);
		glm::mat4 model(1.0f);
