...
const string projName = "022_NORMALMAP";
...
int main()
{
	...
	unsigned int diffuseMap = GenTexture("../Resources/img/brickwall.jpg");
	unsigned int normalMap = GenTexture("../Resources/img/brickwall_normal.jpg");
	Shader shader("../022_NormalMap/normalmap.vert", "../022_NormalMap/normalmap.frag");
	shader.Use();
