...
const string projName = "023_ParallaxMapping";
...
int main()
{
	...
	unsigned int diffuseMap = GenTexture("../Resources/img/bricks2.jpg");
	unsigned int normalMap = GenTexture("../Resources/img/bricks2_normal.jpg");
	unsigned int parallaxMap = GenTexture("../Resources/img/bricks2_disp.jpg");
	Shader shader("../023_ParallaxMapping/parallax.vert", "../023_ParallaxMapping/parallax.frag");
	shader.Use();
