...
// Light attributes
glm::vec3 lightPos(1.2f, 0.0f, -7.0f);
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "LearnOpenGL_LightMap", nullptr, nullptr);
	...
	Shader lightingShader("../010_LightMap/lighting.vs", "../010_LightMap/lighting.frag");
	Shader lampShader("../010_LightMap/lamp.vs", "../010_LightMap/lamp.frag");
