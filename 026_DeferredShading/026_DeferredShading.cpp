...
int main()
{
	...
	//配置shader 
	Shader shaderGeometryPass(vertName, fragName);
	Shader shaderLightingPass(shaderDir+"deferredshading"+vertSuffix,shaderDir+ "deferredshading"+fragSuffix);
	//灯光shader
	Shader shaderLightBox(shaderDir + "lightbox" + vertSuffix, shaderDir + "lightbox" + fragSuffix);

	Model nanosuit("../Resources/013/nanosuit/nanosuit.obj");
	std::vector<glm::vec3> objectPositions;
	objectPositions.push_back(glm::vec3(-3.0, -3.0, -3.0 + offset));
	objectPositions.push_back(glm::vec3(0.0, -3.0, -3.0 + offset));
	objectPositions.push_back(glm::vec3(3.0, -3.0, -3.0 + offset));
	objectPositions.push_back(glm::vec3(-3.0, -3.0, 0.0 + offset));
	objectPositions.push_back(glm::vec3(0.0, -3.0, 0.0 + offset));
	objectPositions.push_back(glm::vec3(3.0, -3.0, 0.0 + offset));
	objectPositions.push_back(glm::vec3(-3.0, -3.0, 3.0 + offset));
	objectPositions.push_back(glm::vec3(0.0, -3.0, 3.0 + offset));
	objectPositions.push_back(glm::vec3(3.0, -3.0, 3.0 + offset));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		RendQuad();
		//copy framebuffer的深度缓冲区到默认帧缓冲的深度缓冲区
